            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    ...
                    <div class="panel-body">
                            <form method="POST" role="form" action="{{asset('dashboard/login')}}">
    {!! csrf_field() !!}
                            <fieldset>
                                <div class="form-group">
                                    <input class="form-control" placeholder="E-mail" type="email" name="email" value="{{ old('email') }}" autofocus="" required="required">
                                </div>
                                <div class="form-group">
